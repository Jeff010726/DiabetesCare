...
export const en = {
  ...
  servicePages: {
    ...
    booking: {
      hero: {
        badge: "Free 15-minute consultation",
        title: "Check insurance coverage before you book",
        desc: "Many insurance plans may cover eligible diabetes education and nutrition services at no cost to you. Start with a free 15-minute call or message us on WhatsApp to check whether your plan may be covered.",
        bookButton: "Book free call",
        whatsappButton: "Ask on WhatsApp",
        highlights: ["Most eligible plans may cover care", "$0 cost may be available", "Free call before scheduling"],
        coverageCardLabel: "Coverage check",
        coverageCardDesc: "may be available with eligible benefits.",
      },
      form: {
        eyebrow: "Free call request",
        title: "Book a free call to check insurance coverage",
        intro: "Tell us how to reach you. We will call during your selected time window when we are available.",
        fields: {
          name: "What should we call you?",
          email: "Email",
          phone: "Phone Number",
          patientType: "Are you a new or returning patient?",
          age: "Age",
          preferredLanguage: "Preferred Language",
          availability: "When are you usually available each day?",
          insuranceCompany: "Insurance company name (optional)",
          insuranceMemberId: "Insurance member ID (optional)",
        ...
        placeholders: {
          ...
          availability: "Select a time window",
          insuranceCompany: "Example: Aetna, UnitedHealthcare, Medicaid",
          insuranceMemberId: "Member ID on your insurance card",
        },
        ...
        patientTypeOptions: ["New patient", "Returning patient"],
        submitting: "Submitting...",
        submit: "Book a free call",
        fallbackError: "We couldn't submit your request. Please try again or contact us on WhatsApp.",
        disclaimer: "Coverage depends on eligibility, diagnosis, referral requirements, and plan benefits. We can help review available options during the free call or by WhatsApp.",
      },
      success: {
      ...
      sticky: {
        close: "Close booking reminder",
        mobileBadge: "Insurance",
        mobileTitle: "Check coverage before booking",
        mobileDesc: "$0 cost may be available with eligible benefits.",
        desktopBadge: "Insurance check",
        desktopTitle: "See if your insurance may cover diabetes care at $0 cost",
        desktopDesc: "Book a free 15-minute call or ask on WhatsApp before scheduling.",
        bookButton: "Book free call",
        whatsappButton: "WhatsApp",
      },
      whatsapp: {
        badge: "WhatsApp booking",
        title: "Ask about coverage on WhatsApp",
        desc: "We are opening WhatsApp so you can ask whether your insurance may be covered and request a consultation time.",
        whatsappButton: "Ask on WhatsApp",
        formButton: "Use booking form",
        cardTitle: "Coverage and booking",
        cardDesc: "Send a WhatsApp message to ask whether eligible services may be covered, or use the booking form for a free call request.",
      },
    },
    classes: {
