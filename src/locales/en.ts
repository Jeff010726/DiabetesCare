...
export const en = {
  ...
  servicePages: {
    ...
    classes: {
      ...
      ctaBody: "These classes are fully covered by Medicare / Medicaid and most private insurance plans when referred by your doctor. Download the referral form for your doctor to sign, or contact us directly to verify your benefits.",
